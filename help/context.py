HELP_TEXTS = {
    ...
    "reports": (
        ...
        "- <strong>Comptes annuels</strong> (PDF, Excel, XBRL) : document légal complet avec "
        "résumé, ventilation, patrimoine et journal<br>"
        "- <strong>Export XBRL (BNB)</strong> : fichier au format XBRL pour le dépôt "
        "électronique à la Banque Nationale de Belgique (modèle micro m08)<br>"
